...
if [ "${isMove}" = "y" ]; then
cd /etc/v2ray
get https://raw.githubusercontent.com/Howardnm/vtworay/main/config_mkcp_detour.json 
get https://raw.githubusercontent.com/Howardnm/vtworay/main/config_tcp.json 
get https://raw.githubusercontent.com/Howardnm/vtworay/main/config_mkcp.json
